...
class PrepareMsgObjectsDetection():
  ...
  def prepareMsgObjectsDetection(self, __depth_image: np.ndarray, labels: list, start_pts: list, end_pts: list) -> ObjectsDetection:
  ...
  def __prepareMsgObjectDetection(self, __depth_image: np.ndarray, what_is: str, start_pt: list, end_pt: list) -> ObjectDetection:
    ...
    face_depth_view   = __depth_image[( int(up_left_pt.y) + padding_height ): ( int(down_right_pt.y) - padding_height ),
                                      ( int(up_left_pt.x) + padding_width ): ( int(down_right_pt.x) - padding_width ) ]
